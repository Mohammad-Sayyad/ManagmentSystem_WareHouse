...
hi there i changed somthing new here 
...
Interfaces to define contracts between classes and ensure consistency.
Aggregation to manage multiple objects within a class.
Generics to enhance flexibility and reuse of code with various data types.
